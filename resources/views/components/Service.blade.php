<section id="service" class="bg-light py-5">
    <div class="container py-4">
        <h1 class="display-4 fw-bold mb-5" style="color: #1d0948" data-aos="fade-left">خدماتنا</h1>
        ...
        <div class="row g-4">
                ...
                <div class="service-card-wrapper">
                    <div class="card h-100 border-0 service-card" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center text-center p-3">
                            <img src="{{ asset('images/Monitor_Smartphone_1.svg') }}" alt="بناء و تصميم واجهات وتجربة المتسخدم" width="50" height="50" class="mb-2">
                            <h3 class="h6 text-primary mb-2">بناء و تصميم واجهات وتجربة المتسخدم</h3>
                ...
                <div class="service-card-wrapper">
                    <div class="card h-100 border-0 service-card" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center text-center p-3">
                            ...
                            <h3 class="h6 text-primary mb-2">تطوير المواقع الالكترونية</h3>
                            <button type="button" class="btn btn-primary btn-sm py-1 px-2 mt-auto service-btn" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#projectModal">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('images/Vector.svg') }}" alt="ابدأ مشروعك" width="16" height="12" class="ms-1">
                                    <span style="font-size: 0.85rem;">ابدأ مشروعك</span>
                ...
                <div class="service-card-wrapper">
                    <div class="card h-100 border-0 service-card" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center text-center p-3">
                            ...
                            <h3 class="h6 text-primary mb-2">تطوير تطبيقات الهواتف الذكية</h3>
                            <button type="button" class="btn btn-primary btn-sm py-1 px-2 mt-auto service-btn" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#projectModal">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('images/Vector.svg') }}" alt="ابدأ مشروعك" width="16" height="12" class="ms-1">
                                    <span style="font-size: 0.85rem;">ابدأ مشروعك</span>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-left" data-aos-delay="300">
                <div class="service-card-wrapper">
                    <div class="card h-100 border-0 service-card" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center text-center p-3">
                            <img src="{{ asset('images/serverss_1.svg') }}" alt="ادارة الاستضافات و الخوادم" width="50" height="50" class="mb-2">
                            <h3 class="h6 text-primary mb-2">ادارة الاستضافات و الخوادم</h3>
                            <button type="button" class="btn btn-primary btn-sm py-1 px-2 mt-auto service-btn" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#projectModal">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('images/Vector.svg') }}" alt="ابدأ مشروعك" width="16" height="12" class="ms-1">
                                    <span style="font-size: 0.85rem;">ابدأ مشروعك</span>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-left" data-aos-delay="400">
                <div class="service-card-wrapper">
                    <div class="card h-100 border-0 service-card" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center text-center p-3">
                            <img src="{{ asset('images/idas_1.png') }}" alt="تقديم الاستشارات التقنية" width="50" height="50" class="mb-2">
                            <h3 class="h6 text-primary mb-2">تقديم الاستشارات التقنية</h3>
                            <button type="button" class="btn btn-primary btn-sm py-1 px-2 mt-auto service-btn" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#projectModal">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('images/Vector.svg') }}" alt="ابدأ مشروعك" width="16" height="12" class="ms-1">
                                    <span style="font-size: 0.85rem;">ابدأ مشروعك</span>
